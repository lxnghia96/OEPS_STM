...
#if ADC_INTERNAL
    command_calibrate_dac_Internal();
#else
...
#if ADC_INTERNAL
    command_set_dac_cal_Internal(received_data + 10);
#else
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MODE_SW_Pin | I_E_SWITCH_Pin | RANGE1_Pin | RANGE2_Pin | RANGE3_Pin | RANGE4_Pin | CELL_ON_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = MODE_SW_Pin | RANGE1_Pin | RANGE2_Pin | RANGE3_Pin | RANGE4_Pin | CELL_ON_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
